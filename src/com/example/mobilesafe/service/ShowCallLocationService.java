...
import com.example.mobilesafe.R;
import com.example.mobilesafe.db.dao.NumberAddressDao;
//在后台监听电话呼入的状态
	...
	private class MyPhoneListener extends PhoneStateListener {
		...
		public void onCallStateChanged(int state, String incomingNumber) {
			...
			case TelephonyManager.CALL_STATE_RINGING:// 手机铃声正在响.
				...
				Log.i("dai", "showcalllocation1");
				String address = NumberAddressDao.getAddress(incomingNumber);
				Log.i("dai", address);
				//使用系统的吐司来显示归属地信息，但显示的时间较短
				//Toast.makeText(getApplicationContext(), "归属地:"+address, 10000).show();
				//Log.i("dai", "showcalllocation2");
